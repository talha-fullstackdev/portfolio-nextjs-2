...
const GetInTouch = () => {
  return (
    ...
    <div className="px-10 text-center pt-28 max-w-[700px] m-auto md:pb-20 pb-2 ">
      ...
      <button className="mt-10 border  dark:hover:text-blue-500 dark:border-1 dark:text-black border-blue-400  text-blue-400 p-2 px-4 rounded-sm hover:text-blue-200"><a href="mailto:nawazt964@gmail.com">say Hello </a></button>
    </div>
    </div>
    </AnimatedWrapper>
  );
