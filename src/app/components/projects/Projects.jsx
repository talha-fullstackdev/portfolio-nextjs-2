          ...
          {projectsData.length > 6 && (
            <div className="flex justify-center mt-8">
              <button
                ...
                className="px-6 py-2 border dark:hover:text-blue-500 dark:border-1 dark:text-black border-blue-400 text-blue-400 hover:text-blue-200 rounded-sm  md:mt-14 hover:rotate-12 transition-all duration-500"
              >
